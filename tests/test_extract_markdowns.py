...
from src.converters import extract_markdown_images, extract_markdown_links
...
class testExtractMarkdowns(unittest.TestCase):
    ...
    def test_extract_markdown_links(self):
        matches = extract_markdown_links(
            "This is text with a link [to boot](https://www.boot.dev)"
        )
        self.assertListEqual([("to boot", "https://www.boot.dev")], matches)
